...
(function($){
    ...
    function create_new_item_from_form(form, modname, modvar){
        ...
        var wrp = [];
        wrp.push('<h2><img class="item-delete" src="'+IMG_DELETELINK_PATH+'" /><span class="handle"></span> <span class="modname">'+modname+'</span> &nbsp;<span class="collapse collapse-toggle">'+feincms_gettext('Hide')+'</span></h2>');
    ...
    $(document).ready(function($){
        ...
        $('h2 span.collapse').live('click', function(){
            var node = this;
            $(this.parentNode.parentNode).children('.item-content, .item-controls').toggle(0,function(){
